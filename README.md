...
- M1 的测试基线、中文工作台、统一 `ModelTrace`、共享 Store、播放状态机与中文课程引擎已经完成，下一交付点是二维计算视图。
- 当前页面已经可以学习 Token、Attention、Output 三章八项中文课程，查看公式、张量形状和教学伪代码，并进行前后导航、播放、暂停和重置；二维图与三维场景仍是教学预览，将在后续工作包替换。
