...
状态：M1 已完成，M2 进行中（WP-20～WP-25 已完成）
...
### WP-44｜生产静态发布准备（已完成，按实际架构调整）

- 使用 Cloudflare 域名、Nginx SPA 回退、静态资源长期缓存和首页禁止缓存；由 GitHub Actions 部署到生产 Docker 容器。
